...
import SupprimerSortieButton
    from "../../mes-sorties/supprimer-sortie-button";
import AnnulerSortieButton
    from "../../mes-sorties/annuler-sortie-button";
import {
    afficherAllure,
    afficherDuree,
    afficherIntensite,
...
`)
    ...
    const {
        count: nombreDemandesInteraction,
        error: demandesInteractionError,
    } = await supabase
    ...
    const aDesInteractions =
        ...
        Boolean(
            demandesInteractionError ||
            conversationsInteractionError
        );
