    ...
    useEffect(() => {
        ...
        async function initialiser() {
            ...
            if (aalError) {
                ...
                setErreur(
                    "Impossible de vérifier l'état de sécurité du compte."
                );
            ...
            if (factorsError) {
                ...
                setErreur(
                    "Impossible de charger le second facteur."
                );
            ...
            if (!facteur) {
                ...
                setErreur(
                    "Aucun facteur MFA valide n'a été trouvé."
                );
